...
if __name__ == '__main__':
    data_dir = os.path.join('./cv-cnn-lpr-main/data/train/cnn_char_train')
    #cv-cnn-lpr-main\data\train\cnn_char_train
    test_dir = os.path.join('./cv-cnn-lpr-main/data/train/cnn_char_test')
    train_model_path = os.path.join('./cv-cnn-lpr-main/data/model/char_recognize/model.ckpt')
    model_path = os.path.join('./cv-cnn-lpr-main/data/model/char_recognize/model.ckpt-600')
